import{j as a}from"./jsx-runtime-u17CrQMm.js";function c({task:{id:e,title:i,state:n},onArchiveTask:u,onPinTask:m}){return a.jsxs("div",{className:`list-item ${n}`,children:[a.jsxs("label",{htmlFor:`archiveTask-${e}`,"aria-label":`archiveTask-${e}`,className:"checkbox",children:[a.jsx("input",{type:"checkbox",disabled:!0,name:"checked",id:`archiveTask-${e}`,checked:n=="TASK_ARCHIVED"}),a.jsx("span",{className:"checkbox-custom",onClick:()=>u(e)})]}),a.jsx("label",{htmlFor:`title-${e}`,className:"title",children:a.jsx("input",{type:"text",value:i,readOnly:!0,name:"title",id:`title-${e}`,placeholder:"Input title","aria-label":i})}),n!=="TASK_ARCHIVED"&&a.jsx("button",{className:"pin-button",onClick:()=>m(e),id:`pinTask-${e}`,"aria-label":`pinTask-${e}`,children:a.jsx("span",{className:"ìcon-star"})},`pinTask-${e}`)]})}c.__docgenInfo={description:"",methods:[],displayName:"Task",props:{task:{required:!0,tsType:{name:"signature",type:"object",raw:`{
    id : string;
    title: string;
